      ...
      <div className="landscape flex justify-center">
        <div className="w-full h-full flex flex-col gap-8 z-50 items-center">
          <motion.div
            ...
            className="lg:text-4xl md:text-2xl  mt-8 mb-8 font-bold w-[90%]  uppercase text1 hidden md:block"
          >
          ...
          <motion.div
            ...
            className="lg:text-2xl md:text-xl text-md md:mt-20 mt-20  font-bold w-[90%]  uppercase text1 "
          >
            STUDENTS' UNION
          </motion.div>
          ...
          <motion.div
            ...
            className="lg:text-2xl md:text-sm text-md md:mt-[130px] mt-[110px] font-md w-[90%] text1"
          >
            presents
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          initial={{ scale: 0.5 }}
          animate={{ scale: 1 }}
          className="absolute flex flex-col w-[90%] justify-center items-center md:top-[50%] top-[40%]"
          style={{ zIndex: 50 }}
        >
          <svg
